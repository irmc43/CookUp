  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.text}>
        Diese App wurde im Rahmen des Moduls "Mobile Computing" an der Hochschule Ruhr West entwickelt.
      </Text>
      ...
      <Text style={styles.text}>Hochschule Ruhr West{"\n"}Lützowstraße 5{"\n"}46236 Bottrop</Text>

      <Text style={styles.sectionTitle}>Kontakt:</Text>
      <Text style={styles.text}>E-Mail: Irem.Cam@stud.hs-ruhrwest.de</Text>
      ...
      <Text style={styles.text}>
        Sie haben das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung der Verarbeitung, Widerspruch und Datenübertragbarkeit. Wenden Sie sich dafür bitte an: Irem.Cam@stud.hs-ruhrwest.de.
      </Text>
